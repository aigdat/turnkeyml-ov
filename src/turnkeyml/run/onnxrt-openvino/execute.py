...
def create_conda_env(conda_env_name: str, requirements: list, python_version: str = "3.8"):
    ...
    try:
        ...
        if not os.path.exists(env_path):
            plugin_helpers.run_subprocess([conda_path, "create", "--name", conda_env_name, f"python={python_version}", "-y"])
